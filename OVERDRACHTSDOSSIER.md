# Overdrachtsdossier BeleidsWijzer Wassenaar

**Laatste update:** 25 februari 2026

---

## Verborgen items (pas op de plaats)

De volgende onderdelen zijn **niet meer via het menu bereikbaar** (besluit 25 feb 2026). Ze blijven in de codebase en kunnen later weer zichtbaar worden gemaakt na overleg met opdrachtgever.
...
## Overige overdrachtsinformatie

*(Hier kunnen later andere overdrachtsnotities worden toegevoegd.)*

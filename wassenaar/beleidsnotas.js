...
(function () {
    ...
    const INITIELE_DATA = [
        ...
        { document: 'Startnotitie Participatie Omgevingsvisie', toelichting: 'Raad 17 dec 2025; streef vaststelling visie 1 apr 2027', link: 'https://wassenaar.bestuurlijkeinformatie.nl/Agenda/Document/4df79561-b943-43a1-a21d-da484727f1ad?documentId=416f5b70-c39b-47d4-b662-be73d3e71c63&agendaItemId=5abb6d11-0c07-463f-a4c0-10b66f8e58a8', bbv: 'H8', geverifieerd: false, initialen: '' },
        ...
        { document: 'Beleidsregels milieuzonering (Omgevingswet)', toelichting: 'College — zoek iBabs', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        { document: 'Nota hogere waarden verkeerslawaai (Omgevingswet)', toelichting: 'College — zoek iBabs', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        ...
        { document: 'Programma Noordrand (uitvoeringsprogramma Groene Zone)', toelichting: 'College 2025; participatie 2023–24; definitief stuk iBabs', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        ...
        { document: 'Samenhangende aanpak versterking dorpskern Wassenaar', toelichting: 'Vier pilaren; wonen in centrum / omgevingsplan (OD)', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        ...
        { document: 'Beheervisie Openbare Ruimte 2024–2028', toelichting: 'Kader beheer OR + uitvoeringsprogramma — PDF/iBabs zoeken', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        { document: 'Beheervisie Openbare Ruimte 2024–2028', toelichting: 'Zelfde — BBV 8.1 Ruimte en leefomgeving', link: '', bbv: '8.1', geverifieerd: false, initialen: '' },
        ...
        { document: 'Evenementenbeleid — uitwerking Omgevingsvisie', toelichting: 'Startnotitie 2021 vastgesteld', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        { document: 'BOPA horeca Raadhuis De Paauw', toelichting: 'Buitenplanse omgevingsplanactiviteit (OD)', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        { document: 'Vijfde wijziging GR Omgevingsdienst Haaglanden', toelichting: 'Raad dec 2025 — iBabs-link zelf controleren', link: '', bbv: 'H8', geverifieerd: false, initialen: '' },
        ...
        { document: 'Sportvisie Wassenaar 2025', toelichting: 'Raadsvergadering 22 sept 2025 — iBabs Agenda/Document', link: 'https://wassenaar.bestuurlijkeinformatie.nl/agenda/document/1aa85158-78d3-4914-a5b9-ee0d1bf4fc31?documentId=6db01b2d-15c8-4801-a2e2-521606bb81c4&agendaItemId=fea9db3b-6a30-47e4-8337-629eaeca711b', bbv: 'H5', geverifieerd: false, initialen: '' },
        ...
        { document: 'Verordening leerlingenvervoer 2025 gemeente Wassenaar', toelichting: 'Raadsbesluit 22 sept 2025 (hamerstuk 6.b); iBabs Agenda/Document', link: 'https://wassenaar.bestuurlijkeinformatie.nl/agenda/document/1aa85158-78d3-4914-a5b9-ee0d1bf4fc31?documentId=eec09f18-31bb-4477-9559-7a73cad358ee&agendaItemId=fea9db3b-6a30-47e4-8337-629eaeca711b', bbv: 'H4', geverifieerd: false, initialen: '' },
        { document: 'Verordening leerlingenvervoer 2025 gemeente Wassenaar', toelichting: 'Zelfde stuk — BBV 4.3 Onderwijsbeleid en leerlingzaken', link: 'https://wassenaar.bestuurlijkeinformatie.nl/agenda/document/1aa85158-78d3-4914-a5b9-ee0d1bf4fc31?documentId=eec09f18-31bb-4477-9559-7a73cad358ee&agendaItemId=fea9db3b-6a30-47e4-8337-629eaeca711b', bbv: '4.3', geverifieerd: false, initialen: '' },
